...
Nova.booting(function (Vue, router, store) {
  Vue.component('index-simple-tag-field', __webpack_require__(3));
  Vue.component('detail-simple-tag-field', __webpack_require__(6));
  Vue.component('form-simple-tag-field', __webpack_require__(9));
});
    ...
    _vm._l(_vm.field.value, function(value) {
      return _c(
        "span",
        {
          key: value,
          staticClass:
            "rounded-full px-2 py-1 whitespace-no-wrap text-xs font-bold text-xs uppercase bg-gray-200 mr-2"
        },
        [_vm._v(_vm._s(value))]
      )
    }),
